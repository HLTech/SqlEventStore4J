...
trait ExperimentalOracleContainerTest {

    static Logger log = LoggerFactory.getLogger(ExperimentalOracleContainerTest.class)
    ...
    private static void migrateDbScripts() {
        Flyway flyway = Flyway
                .configure()
                .locations("db/migration/oracle-experimental")
